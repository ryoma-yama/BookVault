    ...
    <div className="space-y-6">
      ...
      <Form method="post" className="space-y-4">
        ...
        <div>
          ...
          {actionData?.errors?.acquiredDate && (
            <p className="text-sm text-red-500">
              {actionData.errors.acquiredDate.join(", ")}
            </p>
          )}
        </div>
      ...
      <div className="space-y-2">
        ...
        {copies.map((copy: LoaderData["copies"][number]) => (
          <Form
            method="post"
            key={copy.id}
            className="border px-3 py-2 rounded space-y-2"
          >
            ...
            <div>
              ...
              <Input
                type="date"
                name="acquiredDate"
                defaultValue={copy.acquiredDate}
                required
              />
            </div>
            ...
            <div>
              ...
              <Input
                type="date"
                name="discardedDate"
                defaultValue={copy.discardedDate ?? ""}
              />
            </div>
